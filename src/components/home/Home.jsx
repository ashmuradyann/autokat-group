    ...
    return (
        <div className="home">
            ...
            <div className="home-raschot">
                ...
                <div>
                    <p>до <strong>150 000</strong> руб. за 1 кг.</p>
                    <p>Керамические катализаторы от импортных и отечественных автомобилей.</p>
                </div>
                <div>
                    <p>до <strong>9000</strong> руб. за 1 кг.</p>
                    <p>Сажевые фильтры от импортных и отечественных автомобилей</p>
                </div>
                <div>
                    <p>до <strong>19 000</strong> руб. за 1 кг.</p>
                    <p>Металлические катализаторы от импортных и отечественных автомобилей</p>
                </div>
            </div>
